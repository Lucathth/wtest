/**
 * Footer — dark background, 3-column layout.
 * Includes: Logo, Kurzinfo, Nav-Links, Kontakt, Social-Icons, Legal.
 */
...
export default function Footer() {
  return (
    <footer className="bg-[#1a1a2e] text-white px-6 pt-16 pb-8">
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <a href="#" className="flex items-center gap-2 mb-4">
              <span className="w-8 h-8 rounded bg-[#c8102e] flex items-center justify-center text-white font-bold text-sm">
                A
              </span>
            ...
            <div className="flex gap-3 mt-6">
              ...
              <a
                href="#"
                aria-label="LinkedIn"
                className="w-9 h-9 rounded-lg bg-white/8 hover:bg-[#c8102e] flex items-center justify-center transition-colors duration-200"
              >
          ...
          <div>
            ...
            <address className="not-italic flex flex-col gap-3 text-sm text-white/60">
              ...
              <a href="tel:+4989123456789" className="hover:text-white transition-colors">
                +49 89 123 456 789
              </a>
              <a href="mailto:info@abacus-solutions.de" className="hover:text-white transition-colors">
                info@abacus-solutions.de
              </a>
            </address>
          </div>
        </div>
